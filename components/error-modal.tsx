...
const ErrorModal = ({isOpen, closeModal, errorMessage}: {isOpen: boolean, closeModal: VoidFunction, errorMessage: string | undefined}) => {
  return (
    <>
          ...
          <div className="flex min-w-full min-h-full items-center justify-center">
            <Transition.Child
              ...
              <Dialog.Panel className="z-20 bg-white flex flex-col rounded-xl p-5 gap-3 max-w-[85%]">
                ...
                <p className="text-gray-500 text-sm font-semibold">{errorMessage ? errorMessage : "エラーが発生しているようです。画面の指示に従い、もう一度やり直してください。"}</p>
                <div className="mt-4">
                    <Button
